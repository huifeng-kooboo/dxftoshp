...
/***************************************************************************
 dxftpshp
                                 A QGIS plugin
 extract contour with elevation from dxf and transfer to shape file
...
from .dxftoshp_dialog import dxftpshpDialog
import os.path
...
class dxftpshp:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('dxftpshp', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/dxftoshp/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'dxftoshap '),
            callback=self.run,
